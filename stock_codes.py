...
def target_summary_with_num(dataframe, target, numerical_col):
    print(pd.DataFrame({numerical_col: dataframe.groupby(target)[numerical_col].mean()}))
...
def plot_importance(rf_model, features, num=len(X), save=False):
